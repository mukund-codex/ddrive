<?php
	...
	$sql = "SELECT o.*, p.*, r.*, o.created_at as order_date, p.name as product_name FROM orders o JOIN product p ON p.id = o.product_id JOIN registration r ON r.id = o.user_id order by o.id DESC";
	...
	<div class="page-container">
		...
		-->
			...
			<div class="breadcrumb-line">
				...
				<ul class="breadcrumb">
					<li><a href="product-master.php">Home</a></li>
	...
	<?php
		if(isset($_GET['updatesuccess'])){ ?>
			<div class="alert alert-success alert-dismissible" role="alert">
				...
				<i class="icon-checkmark"></i> Product successfully updated.
			</div><br/>
	<?php	} ?>
	<?php
	...
	<?php	} ?>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h6 class="panel-title"><i class="icon-stats"></i> Orders</h6>
				</div>
...
?>
								<tr class="orders">
                                    ...
                                    <td><img src="../images/product/<?php echo $row['image'] ?>" width="100" /></td>
