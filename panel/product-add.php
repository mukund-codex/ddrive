						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-4">
									...
									<input type="file" class="form-control" name="image" id="image" accept="image/jpg,image/png,image/jpeg" <?php if(!isset($_GET['edit'])) { echo 'required'; } ?> id="" data-image-index="0" />
									...
									?>
										<img src="../images/product/<?php echo $file_name.'_crop.'.$ext ?>" width="100"  />
									<?php
									} ?>
								</div>
								<!-- <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="<?php if(isset($_GET['edit'])){ echo $data['name']; }?>" />
									<!-- <input type="text" class="form-control"  required  name="title" id="" value=""/> -->
                                </div>
                                <div class="col-sm-4">
                                    <label>Price <span style="color:red">*</span> </label>
                                    <input type="text" class="form-control" name="price" id="price" value="<?php if(isset($_GET['edit'])){ echo $data['price']; }?>" />
								</div>
							</div>
							<br>
							<div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="discount" id="discount" value="<?php if(isset($_GET['edit'])){ echo $data['discount']; }?>" />
                                </div>
                                
                                <div class="col-sm-8">
                                    <label>Description <span style="color:red">*</span> </label>
                                    <textarea name="description" id="description" class="form-control"><?php if(isset($_GET['edit'])){ echo $data['description']; }?></textarea>
								</div>
							</div>	
