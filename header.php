...
<div id="preloder">
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="header__cart__price">Cart item: <span>&#8377 150.00</span></div>
        </div>
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> ddriversion@gmail.com</li>
                <li>Free Shipping for all Order of &#8377 1000</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
